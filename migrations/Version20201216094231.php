 ...
 */
final class Version20201216094231 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE program ADD slug VARCHAR(255) NOT NULL, CHANGE synopsis synopsis LONGTEXT NOT NULL, CHANGE country country VARCHAR(255) NOT NULL, CHANGE year year INT NOT NULL, CHANGE summary summary LONGTEXT NOT NULL');
